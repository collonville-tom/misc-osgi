                ...
                script {
                    ...
                    withCredentials([sshUserPrivateKey(credentialsId: 'home-ssh-key', keyFileVariable: 'SSH_KEY', usernameVariable: 'SITE_USER')]) {
                        sh '''
                            ...
                            echo "✅ Packet debian déployé avec succès sur https://collonvillethomas.freeboxos.fr/apt/depot/livraison/"
                        '''
                    }
                }
            }
                ...
                script {
                    ...
                    withCredentials([sshUserPrivateKey(credentialsId: 'home-ssh-key', keyFileVariable: 'SSH_KEY', usernameVariable: 'SITE_USER')]) {
                        sh '''
                            ...
                            pwd
                            cd  ./target/staging
                            scp -r ./ ${SITE_USER}@${SERVER_IP}:/mnt/nfs_storage_client/docker_share/tc-public-share/html/projets/${BRANCH_NAME}/misc-osgi
